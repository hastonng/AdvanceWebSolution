...
<html>
        ...
        <nav class="navbar navbar-expand-lg  navbar-dark bg-light mt-3" style="height:3.5rem; background-color:#660099 !important;">
                ...
                <div style="width:12rem; background-color:#660099 !important; border-radius:20px; position:absolute; left:60rem; bottom:-2rem; ">
                ...
                <button class="navbar-toggler navbar-dark" style="background-color:#660099 !important;" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
